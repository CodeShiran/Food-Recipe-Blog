  ...
  return (
    <div className="relative w-full h-[400px] px-[10px] md:px-[50px] text-center mt-[100px] bg-[#E7F9FD] rounded-2xl py-[25px] flex flex-col items-center justify-center z-40 overflow-hidden">
      ...
      <div className="mt-[75px] flex flex-col md:flex-row items-center bg-white rounded-2xl px-2 py-2 shadow-md w-full max-w-[400px] mx-auto gap-3 md:gap-0 z-40">
        ...
        />
        <button className="bg-black text-white px-4 py-2 rounded-2xl md:rounded-l-none hover:bg-gray-800 transition-all duration-150 hover:shadow-2xl cursor-pointer w-full md:w-auto">
          Subscribe
        </button>
      </div>
