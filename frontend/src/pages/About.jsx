  ...
  return (
    <div className='md:px-[50px] px-[25px]'>
        <div className='flex flex-col items-center mt-10'>
            ...
            <p className='mt-[25px] text-center text-gray-500'>We are a team of food enthusiasts dedicated to sharing our love for cooking and delicious recipes. Our mission is to inspire home cooks of all skill levels to create amazing meals for their friends and family.</p>
        </div>
        <div className='flex flex-col  md:flex-row gap-6 mt-10'>
            ...
            <div className='flex-1/2 rounded-lg p-5 flex-col items-start'>
